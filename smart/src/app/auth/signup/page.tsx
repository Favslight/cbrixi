        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-3 pr-12 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/30 focus:bg-white/10 focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 outline-none transition-all glass-card"
              required
            />
            <button
              type="button"
