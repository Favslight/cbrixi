    ...
    >
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <h1 className="text-3xl font-bold text-white mb-2 tracking-tight">
              {tab === "admin" ? "Admin Portal" : "Welcome Back to CBRIXI"}
            </h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div>
          ...
          <input
            ...
            placeholder={tab === "admin" ? "admin@cbrixi.com" : "Enter your email address"}
        ...
        >
          ...
          ) : tab === "admin" ? "🛡️ Enter Admin Portal" : "Login Account"}
        </motion.button>
      </form>

      {/* Social login — user tab only */}
      {tab === "user" && (
        <>
      ...
      {tab === "admin" && (
        <p className="text-center text-white/30 text-xs mt-2">
          Admin access is restricted to authorised CBRIXI personnel only.
        </p>
      )}
    </motion.div>
  );
