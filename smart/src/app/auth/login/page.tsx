...
export default function Login() {
  ...
  return (
    <motion.div
      ...
      className="space-y-8 w-full max-w-md mx-auto p-8 rounded-3xl bg-black/40 border border-white/10 backdrop-blur-2xl shadow-2xl shadow-black/50"
    >
      {/* Header */}
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          type="submit"
          className="w-full py-3.5 px-4 rounded-xl font-semibold text-white bg-gradient-to-r from-blue-500 to-purple-600 glow-blue hover:shadow-lg hover:shadow-blue-500/30 transition-all mt-4"
        >
          Login Account
        </motion.button>
      </form>
      ...
      <div className="relative py-2">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-4 bg-[#07070a] text-white/40">OR</span>
        </div>
      </div>
