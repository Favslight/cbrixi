...
const FOOTER_CATEGORIES = [
  ...
  { label: 'Audio Devices', slug: 'audio-devices' },
          ...
          <div>
            ...
            <ul className="space-y-2">
              {FOOTER_CATEGORIES.map((c) => (
                <li key={c.slug}>
                  <Link href={`/marketplace/${c.slug}`} className="text-[#07070a]/60 dark:text-white/40 hover:text-blue-500 dark:hover:text-white text-sm transition-colors duration-300">
                    {c.label}
                  </Link>
                </li>
              ))}
